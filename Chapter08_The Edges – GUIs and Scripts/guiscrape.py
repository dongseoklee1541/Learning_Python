...
if __name__ == "__main__":
    ...
    _mainframe = ttk.Frame(_root, padding='5 5 5 5')# padding border
    # sticky를 통해서 4방향으로 확장
    ...
    # command=fetch_url : when click button, call fetch_Url function , callback
    _fetch_btn.grid(row=0, column=1, sticky=W, padx=5)
    # padx = x-axis(horizontal) pady = y-axis(vertical)
